...
use Softworx\RocXolid\Forms\Fields\AbstractParentFormField;

class ChildForm extends ParentField
{
    /**
     * @var Form
     */
    ...
    public function __call($method, $arguments)
    {
        ...
        throw new \BadMethodCallException('Method ['.$method.'] does not exist on form ['.get_class($this->form).']');
    }
